...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-400 via-blue-300 to-blue-200 text-amber-900 relative overflow-hidden">
      {/* Farmland Background */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-10 right-20 w-32 h-32">
          ...
          <div className="absolute inset-2 bg-yellow-200 rounded-full blur-lg" />
        </div>
        
        {/* Animated Clouds */}
        <div className="absolute top-10 left-1/4 w-40 h-16 bg-white rounded-full blur-md opacity-90 cloud-float-1" />
        <div className="absolute top-24 left-1/2 w-56 h-20 bg-white rounded-full blur-md opacity-80 cloud-float-2" />
        <div className="absolute top-16 right-1/4 w-48 h-16 bg-white rounded-full blur-md opacity-85 cloud-float-3" />
        <div className="absolute top-32 right-1/3 w-32 h-12 bg-white rounded-full blur-md opacity-75 cloud-float-4" />
        
        {/* Rolling Hills with gradient */}
        <div className="absolute bottom-0 w-full h-64 bg-gradient-to-r from-green-800 via-green-700 to-green-800 rounded-t-[100%] transform translate-y-32" />
        <div className="absolute bottom-0 w-full h-48 bg-gradient-to-r from-green-700 via-green-600 to-green-700 rounded-t-[100%] transform translate-y-24" />
        <div className="absolute bottom-0 w-full h-32 bg-gradient-to-r from-green-600 via-green-500 to-green-600 rounded-t-[100%] transform translate-y-16" />
